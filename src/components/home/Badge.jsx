const Badge = () => {
  return (
    <div className="md:w-1/4 flex justify-center items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1">
      <svg
        width="13"
        height="14"
        viewBox="0 0 13 14"
      ...
      <span>Build Resume in Minutes</span>
    </div>
  );
};
